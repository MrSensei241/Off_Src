    ...
    public partial class Window1 : Window
    {
        ...
        void _makeipf_full(String input, List<String> names)
        {
            ...
            foreach (String directoryname in directories)
            {
                ...
                {
                    ipf.CreatePartialLoadIpf(folderName + "\\" + ipfNmae + ".ipf"
                        , 0, Convert.ToInt32(Window1.myWin.SVN_EndVersion));
        ...
        {
            imc.IPF ipf = new imc.IPF();
            ipf.CreatePartialLoadIpf(Directory.GetCurrentDirectory() + "\\patch\\" + Window1.myWin.SVN_EndVersion + "_001.ipf"
        ...
        void _makepak(String input, List<String> names)
        {
            ...
            ipf.CreateReleaseIpf(Directory.GetCurrentDirectory() + "\\patch\\" + Window1.myWin.SVN_EndVersion + "_001.pak");
        ...
        {
            imc.IPF ipf = new imc.IPF();
            ipf.CreatePartialLoadIpf(Directory.GetCurrentDirectory() + "\\patch\\" + Window1.myWin.SVN_EndVersion + "_001.server", 0, 0);
        ...
        private void AddRemoveList(imc.IPF ipf, String name)
        {
            if (RemoveList.ContainsKey(name))
            {
                foreach (String filename in RemoveList[name])
                {
                    ...
                    _remove = _remove.Substring(_remove.IndexOf("\\") + 1);
